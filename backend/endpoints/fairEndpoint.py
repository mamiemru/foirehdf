...
from backend.models.locationModel import Location

from backend.services.fairService import get_fair_detailed, get_fair, delete_fair
from backend.services.fairService import validate_fair, save_fair, list_fairs, fair_to_dto
from backend.services.locationService import validate_location, save_location
