...
from backend.services.locationService import delete_location
...
def delete_location_dialog(location: LocationDTO):
...
def location_list():
    ...
    locations_list: List[LocationDTO] = list_locations()
