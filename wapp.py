...
from backend.services.attractionService import create_attraction, get_attraction_by_id, list_attractions, list_attractions_names_and_id, update_attraction
from backend.services.fairService import create_fair, get_fair_detailed, list_fair_locations, list_fair_sort_by_status, list_fairs_containing_ride_id, update_fair
from backend.services.locationService import create_location, delete_location, list_locations
from backend.services.manufacturerService import create_manufacturer, delete_manufacturer, list_manufacturers, list_manufacturers_names
...
class FairViewHandler(tornado.web.RequestHandler):
    def get(self, fair_id):
        fair = get_fair_detailed(id=fair_id)
...
class FairFormHandler(tornado.web.RequestHandler):
    def get(self, fair_id=None):
        ...
        fair = get_fair_detailed(fair_id) if is_edit else DotDict()
    ...
    def post(self, fair_id=None):
        ...
        fair_data = {
            ...
            "location": {
                ...
                "id": self.get_argument("location_id", None)
            }
        }
